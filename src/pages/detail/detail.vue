<template>
  <div class="detailContainer">
   ...
   <img @tap="handleMusicPlay" class="music_img" :src="isMusicPlay?'/static/images/music/music-start.png':'/static/images/music/music-stop.png'"/>
...
export default {
  ...
  data(){
    return{
      detailObj:{},
      isCollected:false,//表示文章是否被收藏
      isMusicPlay:false//标识我们的音乐是否播放
    }
  },
  beforeMount(){
    console.log(this);
    ...
    if(!oldStorage){//为空
      ...
      //用户缓存过
      // oldStorage[this.index] ---> false | true | undefined
